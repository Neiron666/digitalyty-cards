export const TRANZILA_CONFIG = {
    ...
    // ── STO / token / recurring terminal (prep-only — not used by runtime logic today) ──
    // stoTerminal is a separate token/STO terminal, NOT a hosted checkout terminal.
    // These fields will be wired once cross-terminal token portability is confirmed (U1).
