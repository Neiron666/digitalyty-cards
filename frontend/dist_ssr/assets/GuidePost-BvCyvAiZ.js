...
const backLink = "_backLink_1wl4v_267";
...
function GuidePost() {
  ...
  if (loading) {
    return /* @__PURE__ */ jsx("main", { className: styles.guideWrap, "data-page": "site", children: /* @__PURE__ */ jsx("p", { className: styles.status, children: "טוען מדריך…" }) });
  }
  if (notFound) {
    return /* @__PURE__ */ jsxs("main", { className: styles.guideWrap, "data-page": "site", children: [
      /* @__PURE__ */ jsx(
        SeoHelmet,
        {
      ...
      /* @__PURE__ */ jsx("p", { className: styles.status, children: "המדריך לא נמצא." }),
      /* @__PURE__ */ jsx("div", { className: styles.backRow, children: /* @__PURE__ */ jsx(Link, { to: "/guides", className: styles.backLink, children: "חזרה למדריכים" }) })
    ] });
  }
  if (error || !post) {
    return /* @__PURE__ */ jsxs("main", { className: styles.guideWrap, "data-page": "site", children: [
    ...
    /* @__PURE__ */ jsx("article", { className: styles.article, children: /* @__PURE__ */ jsxs("div", { className: styles.articleInner, children: [
      ...
      related.length > 0 && /* @__PURE__ */ jsxs(
        "nav",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("h2", { className: styles.relatedTitle, children: "עוד מדריכים" }),
