...
import {
    ...
    createAdminGuidePost,
    updateAdminGuidePost,
    publishAdminGuidePost,
    unpublishAdminGuidePost,
    deleteAdminGuidePost,
    uploadAdminGuideHeroImage,
    uploadAdminGuideSectionImage,
    removeAdminGuideSectionImage,
} from "../../services/admin.service";
import styles from "./AdminGuidesView.module.css";
...
export default function AdminGuidesView() {
    ...
    async function handleCreate() {
        ...
        try {
            ...
            const res = await createAdminGuidePost(body);
            const post = res.data;
    ...
    async function handleUpdate() {
        ...
        try {
            ...
            const res = await updateAdminGuidePost(selectedId, body);
            populateForm(res.data);
    ...
    async function handleSectionImageUpload(idx) {
        ...
        const fileInput = document.getElementById(`guide-sec-img-input-${idx}`);
    ...
    return (
        <div className={styles.wrap}>
            ...
            <div className={styles.topRow}>
                <h2 className={styles.h2}>ניהול מדריכים</h2>
                <Button
                    onClick={() => {
                        resetForm();
                    }}
            ...
            <div className={styles.grid}>
                ...
                <div className={styles.panel}>
                    <h3 className={styles.h3}>מדריכים</h3>
                    ...
                    {!listLoading && posts.length === 0 && (
                        <p className={styles.muted}>אין מדריכים.</p>
                    )}
                ...
                <div className={styles.panel}>
                    <h3 className={styles.h3}>
                        {isEditing ? "עריכת מדריך" : "מדריך חדש"}
                    </h3>

                    {selectedBusy && selectedId && (
                        <p className={styles.muted}>טוען מדריך…</p>
                    )}
                            ...
                            <div key={idx} className={styles.sectionCard}>
                                ...
                                <details className={styles.linkHint}>
                                    ...
                                    <div className={styles.linkHintBody}>
                                        ...
                                        <p>
                                            לקישור פנימי במדריכים, עדיף להשתמש
                                            בנתיב יחסי:
                                        </p>
                                        ...
                                        <code className={styles.linkHintCode}>
                                            [קראו עוד](/guides/getting-started)
                                        </code>
                                        <code className={styles.linkHintCode}>
                                            [לאתר הרשמי](https://example.com)
                                        </code>
                                        <code className={styles.linkHintCode}>
                                            https://cardigo.co.il/guides/digital-card-guide
                                        </code>
                                    </div>
                                </details>
                            </div>
                    ...
                    <div className={styles.sectionBlock}>
                        ...
                        <label className={styles.toggleRow}>
                            <input
                                ...
                                disabled={selectedBusy}
                            />
                            הצג מחבר של הכרטיס במדריך (יציג "ולנטין" בתחתית
                            המדריך)
                        </label>
                    </div>
