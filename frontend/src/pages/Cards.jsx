...
export default function Cards() {
    ...
    return (
        <Page
            ...
            subtitle="כך נראה כרטיס ביקור דיגיטלי מקצועי שנוצר בעזרת Cardigo"
        >
            ...
            <section className={styles.seo}>
                ...
                <p>
                    Cardigo מאפשרת ליצור כרטיס ביקור דיגיטלי לעסקים תוך דקות, עם
                    עיצוב מודרני, כפתורי יצירת קשר, גלריית תמונות, וידאו, המלצות
                    וטופס לידים.
                </p>
            </section>
        </Page>
