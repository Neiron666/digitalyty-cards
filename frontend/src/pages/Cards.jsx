            ...
            <section className={pub.sectionLight}>
                ...
                <div className={pub.sectionWrap}>
                    ...
                    <h2 className={pub.h2Gold}>
                        {" "}
                        עסקים שכבר משתמשים בכרטיס ביקור דיגיטלי של Cardigo{" "}
                    </h2>{" "}
                    <p className={pub.sectionLead}>
                        {" "}
                        הכירו עסקים מתחומים שונים שכבר משתמשים ב-Cardigo כדי
                        להציג את העסק שלהם בצורה מקצועית ונגישה אונליין. כאן
                        תוכלו לראות איך כרטיס ביקור דיגיטלי לעסק נראה בפועל -
                        אצל קליניקות, יועצים, נותני שירות, חנויות, בעלי מקצוע
                        ועסקים מקומיים.{" "}
                    </p>{" "}
