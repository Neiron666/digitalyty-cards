                ...
                <div className={pub.sectionWrap}>
                    ...
                    >
                        ...
                        <p className={styles.presenceLead}>
                            ...
                            , שמציג את העסק שלכם בצורה מקצועית, ברורה ויוקרתית.
                            במקום לשלוח כמה קישורים, להסביר שוב ושוב מה אתם
                            עושים, שתפו כרטיס ביקור דיגיטלי אחד עם כל הפרטים של
                            העסק במקום אחד. הכרטיס משפר את התוצאות שלכם בגוגל,
                            נוח לשיתוף, עם מבנה ברור שעוזר ללקוחות להבין מי אתם,
                            מה אתם מציעים ולמה כדאי לפנות דווקא אליכם.
                            <br />
                        </p>
                    </div>
