...
- claim flow permanently closes eligibility;
- delete/recreate tricks не должны открывать trial заново.

### 8.4 Trial activation truth

Trial активируется на **первом card creation**.

Во время первого создания карточки eligible user получает:
...
- claim flow eligibility closure.
