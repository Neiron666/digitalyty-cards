...
```json
{
  ...
  "autoRenewal": { "status": "cancelled", "canCancel": false, "cancelledAtPresent": true, "subscriptionExpiresAt": "..." },
...
*End of handoff. No source files changed. No runtime logic touched. No env changed. No DB written.*
